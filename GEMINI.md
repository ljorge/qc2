# QC Library - Documentation

## Project Overview

**QC** is a high-performance, precision-agnostic quantum computing simulation library written in C. It was developed to provide a robust foundation for simulating quantum circuits with an emphasis on performance, accuracy, and code clarity.
